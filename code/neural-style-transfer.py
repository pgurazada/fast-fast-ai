...
def plot_content_and_style_images(content_path, style_path):
    plt.figure()
...
content_path = 'pics/Green_Sea_Turtle_grazing_seagrass.jpg'
style_path = 'pics/The_Great_Wave_off_Kanagawa.jpg'

plot_content_and_style_images(content_path, style_path)
